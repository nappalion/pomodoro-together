...
function Menu(props) {
  ...
  useEffect(() => {
    ...
    const usernameRef = ref(database, '/users/' + auth.currentUser.uid + '/username');
  ...
  return (
    <div style={styles.screen}>
        <div style={styles.menu}>
            <IconButton style={styles.profile} src={profileUrl ? profileUrl : require('../assets/default-profile.jpg')} onClick={() => navigate('/profile-picture-form')}/>
